...
export default function FixedBookButton({ fees }: { fees: number }) {
  return (
    <div className="fixed right-0 bottom-0 left-0 z-50 bg-white shadow-2xl">
      <div className="mx-auto flex max-w-4xl flex-col items-center justify-between gap-3 px-4 py-4 sm:flex-row sm:px-6 sm:py-6">
        <div className="flex w-full items-center justify-between sm:w-auto sm:justify-start sm:gap-6">
          <div>
            <p className="font-semibold text-base text-gray-900 sm:text-lg">
        ...
        <Button className="flex w-full items-center justify-center gap-2 rounded-full bg-slate-900 px-6 py-2.5 font-medium text-sm text-white uppercase tracking-widest hover:bg-black sm:w-auto sm:px-8 sm:py-3">
