...
export default function DoctorPage() {
  ...
  return (
    <section className="min-h-screen bg-slate-50 pt-16 pb-40 sm:pt-24">
      <div className="mx-auto max-w-4xl px-3 sm:px-4">
        <div className="rounded-md bg-white shadow-lg">
          {/* Doctor Header */}
          <div className="flex flex-col items-start justify-between gap-4 border-gray-200 border-b px-4 py-4 sm:flex-row sm:items-center sm:gap-6 sm:px-8 sm:py-6">
            <div className="flex-1">
              <h1 className="font-bold text-gray-900 text-lg uppercase tracking-wide sm:text-2xl">
                {doctor.name}
              </h1>
              <div className="mt-1.5 flex items-center gap-2 text-[10px] text-gray-500 uppercase sm:mt-2 sm:text-xs">
              ...
              <div className="mt-1.5 flex items-center gap-2 text-gray-500 text-xs sm:mt-2 sm:text-sm">
